...
class RevealBase extends React__default.Component {
  //getChildContext() {
  ...
  animate(props) {
    ...
    if (leaving) {
      this.savedChild = React__default.cloneElement(this.getChild());
  ...
  cascade(children) {
    ...
    if (typeof children === "string") {
      newChildren = children.split("").map((ch, index) => /* @__PURE__ */ React__default.createElement("span", { key: index, style: { display: "inline-block", whiteSpace: "pre" } }, ch));
    } else
      newChildren = React__default.Children.toArray(children);
    ...
    newChildren = newChildren.map((child) => typeof child === "object" && child ? React__default.cloneElement(child, {
      style: {
        ...child.props.style,
        ...this.state.style,
  ...
  getChild() {
    ...
    if (typeof this.props.children === "object") {
      const child = React__default.Children.only(this.props.children);
      return "type" in child && typeof child.type === "string" || this.props.refProp !== "ref" ? child : /* @__PURE__ */ React__default.createElement("div", null, child);
    } else
      return /* @__PURE__ */ React__default.createElement("div", null, this.props.children);
  }
  render() {
    let mount;
    ...
    const el = React__default.cloneElement(child, props, mount ? newChildren || children : void 0);
    if (this.props.collapse !== void 0)
      return this.props.collapseEl ? React__default.cloneElement(this.props.collapseEl, { style: { ...this.props.collapseEl.style, ...this.props.disabled ? void 0 : this.state.collapse }, children: el }) : /* @__PURE__ */ React__default.createElement("div", { style: this.props.disabled ? void 0 : this.state.collapse, children: el });
    return el;
  }
  makeHandler(handler) {
    const update = () => {
...
function wrapper(props, inEffect, outEffect, children) {
  if ("in" in props)
    props.when = props.in;
  if (React__default.Children.count(children) < 2)
    return /* @__PURE__ */ React__default.createElement(RevealBase$1, { ...props, inEffect, outEffect, children });
  children = React__default.Children.map(
    children,
    (child) => /* @__PURE__ */ React__default.createElement(RevealBase$1, { ...props, inEffect, outEffect, children: child })
  );
  return "Fragment" in React__default ? /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, children) : /* @__PURE__ */ React__default.createElement("span", null, children);
}
